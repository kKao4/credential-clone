...
export default function ButtonOption({ isActive = false, text, ...props }: ButtonOptionProps) {
  return (
    <button {...props} className="flex flex-row items-center text-0.8 w-full py-2.5 justify-evenly text-neutral-100 hover:bg-neutral-600 transition-300 text-start px-4">
